package justfatlard.crosshair_corsair.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("crosshair-corsair-justfatlard")) {
			throw new AssertionError("crosshair-corsair-justfatlard is not loaded: the test is testing nothing");
		}
